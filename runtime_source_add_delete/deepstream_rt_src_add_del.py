...
def add_sources(data):
    ...
    if (g_num_sources == MAX_NUM_SOURCES):
        ...
        GLib.timeout_add_seconds(1, delete_sources, g_source_bin_list)
        return False
...
def main(args):
    args = [None, 'rtsp://admin:avcit12345678@192.168.19.100/ch39/main/av_stream']
    global g_num_sources
    global g_source_bin_list
    global uri
    ...
    print(
        "\n *** DeepStream: Launched RTSP Streaming at rtsp://192.168.31.202:%d/ds-test ***\n\n"
        % rtsp_port_num
    )
